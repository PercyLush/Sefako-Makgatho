...
def prerequisite():
    path = "C:\\Users\\Bheki Lushaba\\Desktop\\Sefako Makgatho\\Science.json"
    ...
    with open(path, "r", encoding="utf-8") as file1:
        ...
        for item in data:
            ...
            if "Prerequisite" in item:
                ...
                if "and" in prerequisite_text or "&" in prerequisite_text or "," in prerequisite_text:
                    if match:
    ...
    with open(path, "r", encoding="utf-8") as file1:
        ...
        for item in data:
            ...
            if "Corequisite" in item:
                ...
                if "and" in corequisite_text or "&" in corequisite_text or "," in corequisite_text:
